...
This module is entirely based on the the work of [Claranet](https://github.com/Claranet/).
...
<!-- BEGIN_TF_DOCS -->
## Global versioning rule for our Azure modules
...
module "logs" {
  source  = "XXX/run-common/azurerm//modules/logs"
  version = "x.x.x"
...
module "diagnostic_settings" {
  source  = "XXX/diagnostic-settings/azurerm"
  version = "x.x.x"
